# unique_time = list(set(all_time_list))  # to remove all duplicate time
# print(unique_date)
unique_time = []
unique_time = ['00:00', '00:05', '00:10', '00:15', '00:20', '00:25', '00:30', '00:35', '00:40', '00:45', '00:50',
               ...
               '23:50', '23:55']
# print(unique_time)
# # below function is to make a list of time interval start
# start = "00:00"
# end = "23:55"
...
#
#     unique_time.append(datetime.datetime.strftime(t, '%H:%M'))
#     t += delta
# print(unique_time)
# # above function is to make a list of time interval end